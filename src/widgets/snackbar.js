module.exports = (widgetToAttach,firstTextSnackbar,delayOfHidingSnackbar = 3000,secondTextSnackbar) =>{
   ...
   return new Promise((resolve)=>{
     ...
     const firstMessage = new TextView({ left: 0, right: 0, font: "15px", centerY: 0, text: firstTextSnackbar, textColor: "#ffffff"}).appendTo(snackbar);
      
     if(secondTextSnackbar !== undefined){

        firstMessage.right = 120;

        new TextView({ right: 0, highlightOnTouch: highlightOnTouchValue, centerY: 0, text: secondTextSnackbar.toUpperCase(), textColor: themeColor, font:"bold 15px"})
        .onTap(() =>{
